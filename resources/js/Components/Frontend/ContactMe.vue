    ...
    <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
        ...
        >
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Have a project in mind or just want to connect? Reach out to
                    discuss your ideas or get started.
                </p>
            </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-accent font-normal">
                                Email me at e.mahdimiftah@gmail.com
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <P class="mb-1 text-paragraph">Casablanca, Morocco.</P>
                            <p class="text-accent font-normal">
